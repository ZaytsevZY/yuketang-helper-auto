...
(function() {
  ...
  const PUBLISH_REMINDER_DEFAULTS = {
  ...
  function getIdentifier(message, entity, op) {
    return firstText(entity, [ "id", "uuid", "quizId", "quiz_id", "examId", "exam_id", "testId", "test_id", "exerciseId", "exercise_id", "presentationId", "presentation_id", "problemId", "problem_id", "activityId", "activity_id" ]) || firstText(message, [ "id", "uuid", "quizId", "quiz_id", "examId", "exam_id", "testId", "test_id", "exerciseId", "exercise_id", "presentationId", "presentation_id", "problemId", "problem_id", "activityId", "activity_id" ]) || op;
  }
 ...
 // E6
  ...
  function createPublishReminder({notify: notify, now: now = () => Date.now(), dedupeMs: dedupeMs = 6e4} = {}) {
