...
- 使用本 fork 的当前构建时，可直接[安装 1.21.5](https://raw.githubusercontent.com/Frank-678/yuketang-helper-auto/main/release/ykt-helper-1215.user.js)。
...
- 设置中可分别选择是否提醒考试/测试题组、课件和其他无法分类的课堂发布；提醒只提示，不会自动作答或提交。
