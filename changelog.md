...
- 覆盖三个受支持雨课堂站点的入口根地址，避免页面站内跳转到 `/v2/web` 后必须手动刷新才能注入脚本

1.21.5

- 新增考试/测试题组、课件和其他课堂发布的可选提醒；每一类均可单独关闭，且不会触发自动作答或提交

- 新增课堂保持亮屏选项，仅在可见的课堂页防止自动熄屏；浏览器后台、手动锁屏和系统省电限制不在可保证范围内

1.21.6

- 修复打开或翻阅旧课件时，`showslide`、`openpresentation` 等展示事件被误判为课件发布并重复提醒的问题
